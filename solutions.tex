...
\end{exercise}
\begin{proof}
The diagram below shows the identifications made to $I_3$ to give $X$. From the diagram, we see that there are two $0$-cells (the orange and burgundy crosses), four $1$-cells (the yellow, cyan, burgundy and orange circles), three $2$-cells (the green, red and burgundy arrows), and one $3$-cell (the interior of the cube).
