...
We are then left with a connected chain of spheres and circles, any two of which share a finite number of points, and such a space is homotopy equivalent to a finite wedge sum of circles and spheres.
\end{proof}
