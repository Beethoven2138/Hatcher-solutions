...
\end{align*} This can then be expressed as the quotient of a direct sum with chosen points $[(x_\alpha,0)]$ as follows:\[SX\cong\left(\bigvee_\alpha SX_\alpha\right)/\sim\] where\[[(x_\alpha,1)]\sim[(x_{\alpha'},1)]\forall \alpha,\alpha'\]
