...
Hence, if we have $n$ spheres, and they form a graph with exactly $m$ loops, then the space is homotopy equivalent to $(\bigvee_{i=1}^m S^1)\vee(\bigvee_{i=1}^n S^2)$.
\end{proof}
